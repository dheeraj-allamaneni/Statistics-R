...
#Temperature(primarily T1) is major cause of uncertainity when compared to to Length
#The coefficient with the changing parameters produces a greater standard deviation when compared to the distributed parameters. The nonlinearity of the coefficient is a factor for this.
...
cbind(Low[1:10],Up[1:10],chk[1:10])
mean(chk)
# (e) Not Gonna find much difference
```
